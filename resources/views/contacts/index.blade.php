            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                   ...
                   <table class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    <tr>
                        <td class="border-t-2 border-gray200 px-4 py-3">{{ $contact->id }}</td>
                        <td class="border-t-2 border-gray200 px-4 py-3">{{ $contact->name }}</td>
                        <td class="border-t-2 border-gray200 px-4 py-3"> {{ $contact->title }}</td>
                        <td class="border-t-2 border-gray200 px-4 py-3">{{ $contact->created_at }}</td>
                        <td class="border-t-2 border-gray200 px-4 py-3"><a class="text-blue-500" href="{{ route('contacts.show', ['id' => $contact->id]) }}">詳細を見る</a></td>
                    </tr>
                    @endforeach
